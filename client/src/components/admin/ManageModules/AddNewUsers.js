...
function ViewUsersForModules() {
  ...
  let [newUsersArray, setNewUsersArray] = useState([]);
  ...
  return (
    <ViewEditMod>
      <div>Assign Users To Modules</div>
      <div class="whole-content">
        ...
        <input
          className="select-module-text-field"
          placeholder="Enter University ID of the User"
          onChange={(event) => setAddedUser(event.target.value)}
        />
        <div style={{ fontSize: "17px" }}>User(s) to be added:</div>
